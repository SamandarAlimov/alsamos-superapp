          ...
          child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, children: [
            Row(children: [
              Container(
                ...
                child: Icon(_sent ? LucideIcons.mailCheck : LucideIcons.keyRound, color: primary, size: 22),
              ),
            ...
            if (_sent) ...[
              Text(
                ...
                style: TextStyle(color: c.foreground.withValues(alpha: 0.8), fontSize: 14, height: 1.45),
              ),
