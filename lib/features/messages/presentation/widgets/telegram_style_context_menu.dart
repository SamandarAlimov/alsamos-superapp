  ...
  static Future<void> show(
    ...
    return showGeneralDialog(
      ...
      pageBuilder: (ctx, a, b) {
        ...
        const reactionWidth = 336.0;
        const padding = 12.0;
        final panelWidth = size.width < reactionWidth + padding * 2
            ? size.width - padding * 2
            : reactionWidth;
        final left =
            (anchor.dx).clamp(padding, size.width - panelWidth - padding);
        var top = anchor.dy;
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child:
                          ...
                          if (onViewInfo != null)
                            _row(ctx, LucideIcons.eye, 'View info', () {
                              Navigator.pop(ctx);
                              onViewInfo();
                            }),
                          if (onReply != null)
                            _row(ctx, LucideIcons.reply, 'Reply', () {
                              Navigator.pop(ctx);
                              onReply();
                            }),
                          if (onForward != null)
                            _row(ctx, LucideIcons.forward, 'Forward', () {
                              Navigator.pop(ctx);
                              onForward();
                            }),
                          if (onCopy != null)
                            _row(ctx, LucideIcons.copy, 'Copy', () {
                              Navigator.pop(ctx);
                              onCopy();
                            }),
                          if (isMine && onEdit != null)
                            _row(ctx, LucideIcons.edit, 'Edit', () {
                              Navigator.pop(ctx);
                              onEdit();
                            }),
                          if (onPin != null)
                          ...
                          if (hasMedia && onDownload != null)
                            _row(ctx, LucideIcons.download, 'Download', () {
                              Navigator.pop(ctx);
                              onDownload();
                            }),
                          if (onCopyLink != null)
                            _row(ctx, LucideIcons.link, 'Copy link', () {
                              Navigator.pop(ctx);
                              onCopyLink();
                            }),
                          if (onSelect != null)
                            _row(ctx, LucideIcons.checkSquare, 'Select', () {
                              Navigator.pop(ctx);
                              onSelect();
                            }),
                          if (onDelete != null)
                            _row(ctx, LucideIcons.trash2, 'Delete', () {
                              Navigator.pop(ctx);
                              onDelete();
    ...
    return InkWell(
        ...
        child: Padding(
          ...
          child: Row(children: [
            ...
            Text(label,
                style:
                    TextStyle(fontSize: 14, color: color ?? colors.foreground)),
          ]),
        ));
  }
}
