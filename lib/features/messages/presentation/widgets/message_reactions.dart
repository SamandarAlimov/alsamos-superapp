...
class ReactionGroup {
  ...
  const ReactionGroup({required this.emoji, required this.count, required this.hasReacted});
}
          ...
          ...reactions.map((r) => GestureDetector(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    color: r.hasReacted ? theme.colorScheme.primary.withValues(alpha: 0.2) : c.muted,
                    border: Border.all(color: r.hasReacted ? theme.colorScheme.primary.withValues(alpha: 0.3) : Colors.transparent),
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      Text('${r.count}', style: TextStyle(fontSize: 11, fontWeight: FontWeight.w600, color: r.hasReacted ? theme.colorScheme.primary : c.foreground)),
                    ],
                  ),
                ),
              )),
