...
class StoriesRepository {
  ...
  Future<List<StoryGroup>> fetchStoryGroups(String? currentUserId) async {
    ...
    for (final raw in (rows as List)) {
      ...
      final profile = m['profile'] is Map ? Map<String, dynamic>.from(m['profile'] as Map) : <String, dynamic>{};
